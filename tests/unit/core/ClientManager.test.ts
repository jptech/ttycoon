...
describe('ClientManager', () => {
  ...
  describe('getUpcomingSessionsSummary', () => {
    it('filters and sorts upcoming scheduled sessions at/after current time', () => {
      ...
      const summary = ClientManager.getUpcomingSessionsSummary(client, sessions, { day: 2, hour: 10, minute: 0 })
    ...
    it('excludes current-hour sessions once the hour has started (minute > 0)', () => {
      ...
      const summary = ClientManager.getUpcomingSessionsSummary(client, sessions, { day: 2, hour: 10, minute: 5 })
